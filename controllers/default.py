...
def case_file_history():
    ...
    db.case_file_history.case_file_id.readable=False
    db.case_file_history.case_file_id.writable=False
    db.case_file_history.case_file_ingress.represent = lambda id, row: CAT(SPAN(I(_class='fa fa-arrow-down'), _class='badge badge-success'), '%s' %row.case_file_ingress) if row.case_file_ingress != None else None
    db.case_file_history.case_file_egress.represent = lambda id, row: CAT(SPAN(I(_class='fa fa-arrow-up'), _class='badge badge-danger'), '%s' %row.case_file_egress) if row.case_file_egress != None else None
